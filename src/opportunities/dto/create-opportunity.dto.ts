...
export class CreateOpportunityDto {
  ...
  @ApiPropertyOptional({
    description: 'AI-generated market analysis (auto-generated if not provided)',
    example: 'This fintech startup shows strong potential in the growing digital payments market...'
  })
  @IsOptional()
  @IsString()
